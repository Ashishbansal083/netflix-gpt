...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='w-screen aspect-video pt-[25%] md:pt-[15%] xl:pt-[10%] px-6 absolute  bg-gradient-to-r from-black md:px-20'>
        <h1 className='text-sm my-2 font-semibold text-white sm:text-lg md:text-2xl  lg:text-3xl '>{title}</h1>
        <p className='w-full my-2 text-white text-xs   md:w-1/2 lg:w-1/4 md:text-sm'>{overview.slice(0,200)+"..."}</p>
        <div >
